...
def open_file():
    with open('/Users/koo/PycharmProjects/DeepDive-Scraping/data/inflearn_lecture.json', 'r') as file:
        data = json.load(file)
...
def get_inflearn_detail():
    ...
    with open('/Users/koo/PycharmProjects/DeepDive-Scraping/data/inflearn_lecture_with_detail.json', 'w') as write_file:
